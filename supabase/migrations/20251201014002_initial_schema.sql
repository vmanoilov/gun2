...
DROP POLICY IF EXISTS "Users can view own providers" ON model_providers;
CREATE POLICY "Users can view own providers" ON model_providers
  FOR SELECT USING (auth.uid() = owner_id);

DROP POLICY IF EXISTS "Users can view shared providers" ON model_providers;
CREATE POLICY "Users can view shared providers" ON model_providers
  FOR SELECT USING (is_shared = true);

DROP POLICY IF EXISTS "Users can create providers" ON model_providers;
CREATE POLICY "Users can create providers" ON model_providers
  FOR INSERT WITH CHECK (auth.uid() = owner_id);

DROP POLICY IF EXISTS "Users can update own providers" ON model_providers;
CREATE POLICY "Users can update own providers" ON model_providers
  FOR UPDATE USING (auth.uid() = owner_id);

DROP POLICY IF EXISTS "Users can delete own providers" ON model_providers;
